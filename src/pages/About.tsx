        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-6 space-y-6 text-muted-foreground">
              ...
              <p>
                We apply that experience to industrial robotics teams - manufacturing, warehouse, AMRs, inspection - helping them move from incident to validated change with less manual work. Clean handover when that's the goal, or ongoing engineering when the pipeline needs to keep evolving with you.
              </p>
              <Link
                to="/solutions"
